...
export type InsertFriendOneMutation = {
  __typename?: "mutation_root";
  insert_friend_one?: {
    __typename?: "friend";
    id: number;
...
export type AllOpenOrdersSubscriptionVariables = Exact<{
  [key: string]: never;
}>;
...
export type AllOpenOrdersSubscription = {
  ...
  pizza_order: Array<{
    ...
    id: number;
    order_status: Order_Status_Enum;
    friend: { __typename?: "friend"; username: string };
    pizza: {
      __typename?: "pizza";
      title: string;
      pizza_topping_pizzas: Array<{
        __typename?: "pizza_topping_pizza";
        pizza_topping: { __typename?: "pizza_topping"; emoji: string };
      }>;
    };
  }>;
};
...
export type CreatePizzaMutationVariables = Exact<{
  title?: InputMaybe<Scalars["String"]>;
  pizza_toppings:
    | Array<Pizza_Topping_Pizza_Insert_Input>
...
export type CreatePizzaMutation = {
  ...
  insert_pizza_order_one?: {
    ...
    pizza: {
      ...
      pizza_topping_pizzas: Array<{
        __typename?: "pizza_topping_pizza";
        pizza_topping: { __typename?: "pizza_topping"; title: string };
      }>;
    };
  } | null;
};
...
export type GetFriendsQuery = {
  __typename?: "query_root";
  friend: Array<{ __typename?: "friend"; username: string; id: number }>;
};

export type GetToppingsQueryVariables = Exact<{ [key: string]: never }>;

export type GetToppingsQuery = {
  __typename?: "query_root";
  pizza_topping: Array<{
    __typename?: "pizza_topping";
    id: number;
...
export type MyOpenOrdersSubscription = {
  __typename?: "subscription_root";
  pizza_order: Array<{
    __typename?: "pizza_order";
    id: number;
    order_status: Order_Status_Enum;
    pizza: { __typename?: "pizza"; id: number; title: string };
  }>;
};
...
export type OrderPizzaMutation = {
  __typename?: "mutation_root";
  insert_pizza_order_one?: { __typename?: "pizza_order"; id: number } | null;
};

export type PizzaFragment = {
  __typename?: "pizza";
  id: number;
  title: string;
  pizza_topping_pizzas: Array<{
...
export type UpdateOrderMutation = {
  ...
  update_pizza_order?: {
    __typename?: "pizza_order_mutation_response";
    returning: Array<{ __typename?: "pizza_order"; id: number }>;
  } | null;
};
    ...
    insert_pizza_order_one(
      object: {
        pizza: {
          data: {
            title: $title
            pizza_topping_pizzas: { data: $pizza_toppings }
          }
        }
      }
    ) {
...
export function useCheckFriendQuery(
  options?: Omit<Urql.UseQueryArgs<CheckFriendQueryVariables>, "query">
) {
  return Urql.useQuery<CheckFriendQuery>({
    query: CheckFriendDocument,
    ...options,
  });
}
...
export function useAllOpenOrdersSubscription<TData = AllOpenOrdersSubscription>(
  options: Omit<
    Urql.UseSubscriptionArgs<AllOpenOrdersSubscriptionVariables>,
    "query"
  > = {},
  handler?: Urql.SubscriptionHandler<AllOpenOrdersSubscription, TData>
) {
  return Urql.useSubscription<
    AllOpenOrdersSubscription,
    TData,
    AllOpenOrdersSubscriptionVariables
  >({ query: AllOpenOrdersDocument, ...options }, handler);
}
...
export function useAllPizzasQuery(
  options?: Omit<Urql.UseQueryArgs<AllPizzasQueryVariables>, "query">
) {
  return Urql.useQuery<AllPizzasQuery>({
    query: AllPizzasDocument,
    ...options,
  });
}
...
export function useCreatePizzaMutation() {
  return Urql.useMutation<CreatePizzaMutation, CreatePizzaMutationVariables>(
    CreatePizzaDocument
  );
}
...
export function useGetFriendsQuery(
  ...
  return Urql.useQuery<GetFriendsQuery>({
...
export function useGetToppingsQuery(
  options?: Omit<Urql.UseQueryArgs<GetToppingsQueryVariables>, "query">
) {
  return Urql.useQuery<GetToppingsQuery>({
...
export function useMyOpenOrdersSubscription<TData = MyOpenOrdersSubscription>(
  options: Omit<
    Urql.UseSubscriptionArgs<MyOpenOrdersSubscriptionVariables>,
    "query"
  > = {},
  handler?: Urql.SubscriptionHandler<MyOpenOrdersSubscription, TData>
) {
  return Urql.useSubscription<
    MyOpenOrdersSubscription,
    TData,
    MyOpenOrdersSubscriptionVariables
  >({ query: MyOpenOrdersDocument, ...options }, handler);
}
...
export function useMyPizzasQuery(
  options: Omit<Urql.UseQueryArgs<MyPizzasQueryVariables>, "query">
) {
...
export function useOrderPizzaMutation() {
  return Urql.useMutation<OrderPizzaMutation, OrderPizzaMutationVariables>(
    OrderPizzaDocument
  );
}
